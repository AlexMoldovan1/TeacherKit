...
export class StudentMedia extends React.Component<Props, State> {
  ...
  private handleDeletePhotoForEditedStudent(
    index: number,
    image: UploadedImage
  ) {
    ...
    this.props.handleDeletePhotoForEditedStudent(index, image.dataURL);
  }
            ...
            <li className="liForMedia" key={key}>
              <div className="divForMedia">
                ...
                <button
                  ...
                  onClick={this.handleDeletePhotoForEditedStudent.bind(
                    this,
                    key,
                    image
                  )}
